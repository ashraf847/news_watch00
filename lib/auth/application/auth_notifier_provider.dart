...
import 'package:news_watch/auth/application/app_user_service.dart';
import 'package:news_watch/auth/application/auth_service.dart';
...
class AuthNotifier extends StateNotifier<AppUser?> {
  ...
  Future<void> signInWithEmailAndPassword(
    ...
    try {
      ...
      // await user?.reload(); // Ensure the latest status is fetched
